...
const services = [
  {
    ...
    icon: "⬡",
    bg: "#d5eaf0",
    items: ["Frontend Development", "Backend Development", "CMS Integration", "SEO Optimization", "Performance Tuning"],
  },
  {
    num: "02",
    title: "Branding",
    icon: "◈",
    bg: "#e8dff5",
    items: ["Brand Strategy", "Visual Identity", "Logo Design", "Brand Guidelines", "Motion Branding"],
  },
  {
    num: "03",
    title: "Mobile App",
    icon: "◉",
    bg: "#d8f0e4",
    items: ["iOS Development", "Android Development", "React Native", "UI/UX Design", "App Store Launch"],
  },
  {
    num: "04",
    title: "Desktop App",
    icon: "▣",
    bg: "#fde8d8",
    items: ["Electron Apps", "Cross-platform", "System Integration", "Custom Dashboards", "Offline Support"],
  },
];
              ...
              <div className="flip-card-inner">
                ...
                >
                  <div>
                    ...
                    <h3 className="text-xl font-black text-[#050505] leading-tight">{s.title}</h3>
                  </div>
                ...
                >
                  <div>
                    <h3 className="text-base font-black text-[#f4ede8] mb-5 tracking-tight">{s.title}</h3>
                    <ul className="space-y-2.5">
                      {s.items.map((item) => (
                        <li key={item} className="text-xs text-[#a8a3a0] flex items-center gap-2.5 leading-relaxed">
