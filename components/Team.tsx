...
export default function Team() {
  return (
    <section id="team" className="relative bg-[#f4ede8]" style={{ paddingBottom: '160px' }}>
      {/* Subtle background texture overlay (optional if the body texture is fully transparent, we can reinforce here) */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.02]" style={{ backgroundImage: 'radial-gradient(circle at center, #050505 1px, transparent 1px)', backgroundSize: '24px 24px' }} />
      ...
      <div className="w-full max-w-[1600px] mx-auto pl-12 sm:pl-16 md:pl-28 lg:pl-48 pr-8 sm:pr-12 md:pr-20 lg:pr-32 relative z-10">
        ...
        >
          ...
          <p className="mt-8 text-xl md:text-2xl text-[#050505]/60 max-w-2xl font-medium tracking-tight">
            A multidisciplinary team of designers, engineers and strategists building digital experiences.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-20 gap-x-12 xl:gap-x-14">
          {teamMembers.map((member, index) => (
            ...
            >
              {/* Image Card */}
              <div 
                className="relative mb-8 overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:-translate-y-2 w-[85%]" 
              >
                <img
                  src={member.image}
                  alt={member.name}
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="font-extrabold text-[#050505] tracking-tight mb-1" style={{ fontSize: '2.2rem', lineHeight: '1.1' }}>
                    {member.name}
                  </h3>
                  <p className="font-medium text-[#050505]/60" style={{ fontSize: '1.1rem' }}>{member.role}</p>
                </div>
              </div>

              {/* Companies & Socials (Moved down & organized) */}
              <div className="mt-auto pt-6 border-t-[1.5px] border-[#050505]/10 flex flex-col gap-4">
                <p className="uppercase tracking-[0.18em] text-[#050505]/45 font-bold" style={{ fontSize: '0.8rem' }}>
                  Worked at
                </p>
                ...
                <div className="flex flex-wrap gap-5 items-center justify-between">
                  ...
                  <div className="flex gap-2 text-[#050505]">
                    <a href={member.socials.linkedin} className="border-[1.5px] border-[#050505]/20 p-2 transition-all duration-300 hover:border-[#050505] hover:bg-[#050505] hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#d65a4a] hover:text-[#f4ede8]">
                      <LinkedinIcon />
                    </a>
                    <a href={member.socials.x} className="border-[1.5px] border-[#050505]/20 p-2 transition-all duration-300 hover:border-[#050505] hover:bg-[#050505] hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#d65a4a] hover:text-[#f4ede8]">
                      <XIcon />
                    </a>
                  </div>
                </div>
